          ...
          <div class="bg-white p-6 sm:p-6 sm:pb-4">
            <div class="">
              <div class="mt-3 bg-white text-center sm:ml-4 sm:mt-0 sm:text-left">
                <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Créer un Flash</h3>
                <div class="mt-2">
                  <form @submit.prevent="submitForm">
                    ...
                    <div class="px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                      <button type="submit" class="inline-flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 sm:ml-3 sm:w-auto">Créer</button>
